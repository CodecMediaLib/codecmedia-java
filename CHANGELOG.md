...
- Updated [`PureJavaMp3DecoderTest`](src/test/java/me/tamkungz/codecmedia/internal/audio/mp3/PureJavaMp3DecoderTest.java) to assert the new fail-closed contract instead of expecting the removed synthetic PCM output.
